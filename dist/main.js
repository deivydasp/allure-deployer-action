...
import { Allure, ConsoleNotifier, FirebaseHost, FirebaseService, getReportStats, GoogleStorage, GoogleStorageService, NotifyHandler, SlackNotifier, SlackService, validateResultsPaths, } from "allure-deployer-shared";
...
function monitorCopyProgress(fileStats) {
