...
var createJestEnvironment = Base => {
  ...
  function _handleTestStart(test) {
    ...
    var testUuid = this.runtime.startTest({
      ...
      stage: Stage.RUNNING,
      labels: [getLanguageLabel(), getFrameworkLabel("jest"), getPackageLabel(this.testPath), getHostLabel(), getThreadLabel(env.JEST_WORKER_ID), ...getEnvironmentLabels(), ...getSuiteLabels(newTestSuitePath)]
