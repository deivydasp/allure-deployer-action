...
export declare function getReportStats(summaryJsonDir: string): Promise<ReportStatistic>;
export declare function getDashboardUrl({ projectId, storageBucket, prefix }: {
    prefix?: string;
    projectId?: string;
